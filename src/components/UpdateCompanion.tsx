...
export function UpdateCompanion() {
  ...
  useEffect(() => {
    if (requestId) {
      const foundRequest = dummyUpdateRequests.find(
      ...
      {selectedRequest ? (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p>
                  ...
                  {selectedRequest.oldProfile.description.join(", ")}
                </p>{" "}
                {/* Updated */}
                <p>
                  <strong className="text-gray-700">Age:</strong>{" "}
                  {selectedRequest.oldProfile.age}
                </p>
                <p>
                  <strong className="text-gray-700">Gender:</strong>{" "}
                  {selectedRequest.oldProfile.gender}
                </p>
                <p>
                ...
                <p>
                  ...
                  {selectedRequest.oldProfile.height}
                </p>
              </CardContent>
            </Card>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-6xl w-full mx-auto">
          ...
          <CardFooter className="flex justify-between items-center mt-6">
            ...
            <div className="flex space-x-4">
              <Button
                onClick={() => handleDelete(selectedCompanion.id)}
                variant="destructive"
                className="bg-red-600 hover:bg-red-700"
              >
                Delete
